...
<div class="container-fluid py-4">
    <x-page-header icon="fas fa-edit" title="Edit Amenity: {{ $amenity->amenity_name }}" />
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <x-card title="Quick Actions" bodyClass="card-body" class="mb-3">
                ...
                @if($amenity->amenityRequests->count() > 0)
                    <ul class="list-unstyled mb-0">
                        @foreach($amenity->amenityRequests->take(5) as $req)
                            <li class="mb-2">
                                <small>
                                    <strong>{{ $req->guest->user->full_name ?? 'Guest' }}</strong>
                                    — x{{ $req->quantity }}
